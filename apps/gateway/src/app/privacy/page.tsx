      ...
      <main className="mx-auto max-w-3xl px-6 py-16 font-sans text-gray-800">
        ...
        <section className="mt-10 space-y-6 text-[15px] leading-relaxed">
          ...
          <p>
            ...
            returned, unchanged, so you can diagnose it. That message can quote your own data, and
            the record is visible only to you. Before any error message reaches our analytics
            provider it is redacted for emails, identifiers and quoted content.
          </p>
          <p>
